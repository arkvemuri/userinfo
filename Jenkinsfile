        ...
        stage('Build and Test') {
            ...
            post {
                always {
                    ...
                    // JaCoCo coverage reports are generated by Maven and available in target/site/jacoco/
                    publishHTML([
                        allowMissing: false,
            ...
            steps {
                script {
                    ...
                    if (jacocoReport.contains('<td class="ctr2">') &&
                        jacocoReport.find(/<td class="ctr2">(\d+)%<\/td>/).toInteger() < 30) {
                        error 'Code coverage is below 30%'
                    }
                }
            }
        }
